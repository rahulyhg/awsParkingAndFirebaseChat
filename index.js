    ...
    if (document.getElementById("message").value == "") {
        ...
        db.collection("messages")
            ...
            .then(function (docRef) {
                console.log(
                    "Message written to database with the message:",
...
$("#SubmitButton").on("click", function (e) {
    if (
        ...
        document.getElementById("lot").value > 20 ||
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $.ajax({
                    type: "GET",
                    url: "https://krdw5iimoe.execute-api.us-east-1.amazonaws.com/default/FaaborgParkingLots?lot=" +
                        ln,
                    success: function (data) {
                        $(document)
                            .ajaxStart(function () {
